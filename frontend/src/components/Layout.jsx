...
//children is the main content component of the page
const Layout = ({ children }) => {//this will be the main layout of the application which have the sidebar and the main content area
